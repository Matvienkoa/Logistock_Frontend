...
<Header :title="'Inventaire produit'"/>
  <div class="about">
    ...
    <div class="form-product">
      ...
      <button @click="addStock()" id="add-button" type="button">Ajouter</button>
    </div>

    <router-link v-if="getProduct && getProduct.id" :to="{name: 'warehouse_inventory_product', params: {id: getProduct.id}}">
        retour
    </router-link>
  </div>
<Footer/>
